...
# Generated by qmake (2.01a) (Qt 4.8.7) on: lun. nov. 27 17:58:02 2017
# Project:  main.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/yourAppName1.0.0/ && $(COPY_FILE) --parents mainWidget.h toolsWidget.h drawingWidgetItems.h drawingWidget.h animationWidgetItems.h animationWidget.h scene.h curve1D.h curve2D.h curve1DLinear.h curve1DLagrange.h curve2DLinear.h curve2DInertia.h curve2DHermite.h animatedPoint.h .tmp/yourAppName1.0.0/ && $(COPY_FILE) --parents main.cpp mainWidget.cpp toolsWidget.cpp drawingWidgetItems.cpp drawingWidget.cpp animationWidgetItems.cpp animationWidget.cpp scene.cpp animatedPoint.cpp .tmp/yourAppName1.0.0/ && (cd `dirname .tmp/yourAppName1.0.0` && $(TAR) yourAppName1.0.0.tar yourAppName1.0.0 && $(COMPRESS) yourAppName1.0.0.tar) && $(MOVE) `dirname .tmp/yourAppName1.0.0`/yourAppName1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/yourAppName1.0.0
